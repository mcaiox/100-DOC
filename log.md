...
Only managed to do 42 consecutive days,as I took a break during the winter holiday period.I will start again in the new year and will be logging [here](log2.md)
...
### Day 36: Monday December 14, 2020

**Today's Progress**: I continued on classes in C#.

**Thoughts**: Interesting to use the throw keyword to handle an exception manually.
